        ...
        <div>
            <div>
                <div className="justify-center mb-10">
                    <p className="text-4xl font-bold h-full text-center">{recipe.title}</p>
                </div>
                <div>
                        ...
                        {recipe.ingredients.map((ingredient) => (
                            ...
                            >
                                <div className="min-w-0 flex-1">
                                    ...
                                    <p className="truncate text-gray-500">{(ingredient.quantity / 2) * selected.number} {ingredient.unit}</p>
                                </div>
                                <div className="z-10">
                                    <Checkbox/>
                                </div>
